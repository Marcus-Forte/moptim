...
template <class Model, int OutputDim, ::DifferentiationMethod MethodT = ::DifferentiationMethod::BACKWARD_EULER>
class NumericalCostSycl : public ICost {
 ...
 public:
  ...
  NumericalCostSycl(const sycl::queue& queue, const double* input, const double* observations, size_t input_size)
      : queue_(queue), input_{input}, observations_{observations}, input_size_{input_size} {
