...
TEST(TestPowell, TestPowell) {
  ...
  auto cost = std::make_shared<NumericalCost>(x.data(), x.data(), 1, 4, model);
  GaussNewton solver;
...
TEST(TestPowell, TestPowerllSplit) {
  ...
  auto cost1 = std::make_shared<NumericalCost>(x.data(), x.data(), 1, 1, std::make_shared<PowellF0>());
  auto cost2 = std::make_shared<NumericalCost>(x.data(), x.data(), 1, 1, std::make_shared<PowellF1>());
  auto cost3 = std::make_shared<NumericalCost>(x.data(), x.data(), 1, 1, std::make_shared<PowellF2>());
  auto cost4 = std::make_shared<NumericalCost>(x.data(), x.data(), 1, 1, std::make_shared<PowellF3>());
